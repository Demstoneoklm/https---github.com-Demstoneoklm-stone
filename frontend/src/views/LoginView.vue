...
const loginWithGoogle = () => {
  ...
  // Implémenter la logique OAuth ici
};

const handleForgotPassword = () => {
  const userEmail = prompt('Entrez votre email pour réinitialiser votre mot de passe :');
  if (userEmail) {
    console.log('Demande de réinitialisation pour :', userEmail);
    // Implémenter l'appel API de réinitialisation ici
  }
};
